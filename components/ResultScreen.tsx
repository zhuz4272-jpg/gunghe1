...
export const ResultScreen: React.FC<ResultScreenProps> = ({ onReset }) => {
  ...
  return (
    <div className="bg-[#ecebe4] font-sans text-earth-dark h-[100dvh] w-full flex flex-col relative overflow-hidden animate-in fade-in duration-1000">
        ...
        {/* Header Bar - Absolute positioned */}
        <header className="absolute top-0 left-0 w-full p-4 flex justify-between items-center z-50 pointer-events-none">
           <button 
             onClick={onReset}
             className="w-10 h-10 flex items-center justify-center rounded-full glass-panel hover:bg-white/60 transition-colors shadow-sm text-stone-600 pointer-events-auto"
           >
             <ArrowLeft className="w-5 h-5" />
           </button>
           <div className="text-stone-500 font-serif text-xs tracking-widest uppercase opacity-60 pointer-events-auto">
        ...
        {/* Main Flex Container */}
        <div className="w-full h-full flex flex-col pt-16 pb-6 px-4 relative z-20">
            ...
            <div className="flex-1 min-h-0 w-full flex items-center justify-center mb-6">
                <div ref={cardRef} className="w-full max-w-sm max-h-full bg-earth-light rounded-[4px] shadow-2xl relative overflow-hidden flex flex-col items-center">
                    ...
                    <div className="relative z-10 w-full p-5 flex flex-col h-full items-center">
                        ...
                        {/* Image Specimen - Flexible Height (Keys to fitting one screen) */}
                        ...
                        <div className="text-center w-full shrink-0 mt-1 flex flex-col gap-2">
                            <h1 className="font-serif text-2xl sm:text-3xl font-black text-earth-dark tracking-wide">
                                {TEXTS.RESULT_NAME}
                            </h1>
                            ...
                            <div className="relative py-1">
                                <div className="inline-flex items-center justify-center space-x-2 px-4 relative z-10">
                                    <div className="flex flex-col items-center">
                                        <span className="font-serif font-bold text-terracotta text-lg">{TEXTS.RESULT_TAG_TYPE}</span>
                                    </div>
                                    <div className="h-6 w-px bg-stone-300 transform rotate-12"></div>
                                    <span className="font-serif text-earth-dark/90 text-sm tracking-wide border-b border-dashed border-stone-300 pb-0.5">
                                        {TEXTS.RESULT_TAG_TEXT}
                                    </span>
                                </div>
                                
                                {/* Stamp */}
                                <div className="absolute -right-1 -top-1 transform rotate-[-15deg] opacity-80 mix-blend-multiply pointer-events-none border border-seal-red rounded-full w-12 h-12 flex items-center justify-center">
                                    <div className="absolute inset-0.5 border border-seal-red rounded-full opacity-60"></div>
                                    <span className="text-[8px] text-seal-red font-bold uppercase tracking-widest text-center leading-tight">
                                        Oasis<br/>Verified
                                    </span>
                                </div>
                            </div>
                            ...
                            {/* Quote */}
                            <div className="px-3 py-3 bg-paper-texture border-t border-b border-stone-100 relative mt-1">
                                <span className="absolute top-0 left-1 text-2xl text-stone-200 font-serif leading-none">“</span>
                                <p className="text-earth-dark/80 leading-relaxed font-serif text-xs sm:text-sm italic relative z-10 line-clamp-3">
                                    {TEXTS.RESULT_QUOTE}
                                </p>
                                <span className="absolute bottom-0 right-1 text-2xl text-stone-200 font-serif leading-none transform rotate-180">“</span>
                            </div>

                            {/* Card Footer Details */}
                            <div className="pt-2 w-full flex justify-center items-center opacity-60">
            ...
            <div className="shrink-0 w-full flex items-center justify-center">
                ...
                >
                    <div className="w-14 h-14 bg-gradient-to-br from-terracotta to-[#a83e38] rounded-xl shadow-lg shadow-terracotta/20 border-2 border-[#fff1e6]/20 flex items-center justify-center transform group-hover:-translate-y-1 transition-all duration-300 relative overflow-hidden">
