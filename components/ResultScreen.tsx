  ...
  return (
    <div className="bg-[#ecebe4] font-sans text-earth-dark h-full w-full flex flex-col relative overflow-hidden animate-in fade-in duration-1000">
        ...
        <div className="relative z-20 w-full h-full overflow-y-auto overflow-x-hidden">
            <main className="w-full min-h-full flex flex-col items-center px-4 pt-20 pb-10">
                <div className="w-full max-w-sm flex flex-col items-center">
                    
                    {/* The Paper Card - Wrapper */}
                    <div className="w-full flex flex-col items-center justify-center py-2 mb-6">
